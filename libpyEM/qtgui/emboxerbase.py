...
class ManualBoxingPanel:
	...
	def get_widget(self):
		if self.widget == None:
			...
			hbl = QtGui.QHBoxLayout()
			particle_type_cbox_label = QtGui.QLabel("Particle type:")
			self.particle_type_cbox = QtGui.QComboBox()
			hbl.addWidget(particle_type_cbox_label)
			hbl.addWidget(self.particle_type_cbox)
